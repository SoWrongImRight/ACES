...
class MatchRepository:
    ...
    def create_match(self, cp_per_turn: int = 2, runway_health: int = 20) -> MatchState:
        match_state = build_seeded_match(cp_per_turn=cp_per_turn, runway_health=runway_health)
